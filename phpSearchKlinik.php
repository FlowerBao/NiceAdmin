...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="phpSearchKlinik.php">
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      <li class="nav-item">
        <a class="nav-link " href="dashboard-klinik.php">
          <i class="bi bi-grid"></i>
          <span>Dashboard</span>
        </a>
      </li><!-- End Dashboard Nav -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="add-usage.php">
                    ...
                    <td style="width:5%"><strong>Balance Treatment</strong></td>
                     ...
                     <?php
                            ...
                            if ($conn->connect_error){
                             ...
                             $sql = "(SELECT bil, no_visa, nama, SUM(`jum_rawatan`) AS total, (200 - SUM(`jum_rawatan`)) AS baki FROM penggunaan_staf where nama like '%$search%')";
