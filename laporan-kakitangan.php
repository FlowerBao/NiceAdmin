          ...
          <div class="row">
            ...
            <div class="card-body">
              <div class="col-13">
                ...
                <strong>Choose searching category.</strong><br><br>
                <div class="btn-group">
                  <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                    Category
                  </button>
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <li><a class="dropdown-item" href="dropdown-nama.php">Name Search</a></li>
                    <li><a class="dropdown-item" href="dropdown-tahun.php">Year Search</a></li>
                  </ul>
                </div><br><br>
                  
                <!--button cetak, pdf, excel-->
                ...
                <a class="btn btn-success rounded-pill login-submit-cs" href="#" id="test" onClick="javascript:fnExcelReport();">Excel</a><br><br>
                 ...
                 <table id="data" class="table table-bordered">
                    ...
                    <td><strong>Staff Name</strong></td> <!--0-->
                    <td><strong>Visa/IC Number</strong></td><!--1-->
                    <td><strong>Phone Number</strong></td><!--2-->
                    <td><strong>Year</strong></td><!--3-->
                    <td><strong>Clinic Name</strong></td><!--4-->
                    <td><strong>Treatment Date</strong></td><!--5-->
                    <td><strong>Total Treatment</strong></td><!--6-->
                    <td><strong>Total</strong></td><!--7-->
                    <td><strong>Balance</strong></td><!--8-->
                    </tr>
                     </thead>
                     <tbody>
                    ...
                    <?php
                       ...
                       $sql = "SELECT 
                                    ...
                                    nama_klinik,
                                    t1.tarikh_rawatan, t1.jum_rawatan,
                                    FORMAT (SUM(jum_rawatan) OVER (PARTITION BY nama),2) AS total,
                                    FORMAT (200-SUM(jum_rawatan) OVER (PARTITION BY nama),2) AS baki
                                FROM
                                    penggunaan_staf t1
	...
	<script>
	  	function fnExcelReport() {
			...
			if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
				...
				$('#test').attr('download', 'Staff Usage Report.xls');
			}
