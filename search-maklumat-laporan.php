...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="search-maklumat-laporan.php">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="laporan-maklumat-kakitangan.php">Report</a></li>
          <li class="breadcrumb-item">Search Staff</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <div class="col-13">
                ...
                <a class="btn btn-success rounded-pill login-submit-cs" href="#" id="test" onClick="javascript:fnExcelReport();">Excel</a><br><br>
                 ...
                 <table id="data" class="table table-bordered">
                    ...
                    <td><strong>Allocation</strong></td><!--3-->
                    </tr>
                     </thead>
                     <tbody>
